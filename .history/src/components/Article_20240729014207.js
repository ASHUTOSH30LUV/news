  ...
  return (
    <div className="article">
      <div className="article-header">
        ...
        <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae voluptatem ratione ullam pariatur repudiandae libero saepe ipsum repellat, aspernatur quasi accusamus aliquid facilis. Quam odit voluptatem possimus omnis maiores exercitationem!</h1>
      </div>
      <div className="info-box">
        <span className="author">By Chemical Today.</span>
        <span className="date">19 December 2023</span>
        <div className="share-symbol">
          <span className="share">Share</span>
          <div className="dots" role="button" ></div>
          <div className="dots" role="button" ></div>
          <div className="dots" role="button" ></div>
        </div>
      </div>
