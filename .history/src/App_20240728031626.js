  ...
  return (
    <div className="app">
      ...
      <div className="footer-middle">
        ...
        <div class="icons">
                <a href="https://twitter.com" className="twitter" aria-label="Twitter">
                <span className="visually-hidden">Twitter</span>
              </a>
              <a href="https://youtube.com" className="youtube" aria-label="YouTube">
                <span className="visually-hidden">YouTube</span>
              </a>
              <a href="https://linkedin.com" className="linkedin" aria-label="LinkedIn">
                <span className="visually-hidden">LinkedIn</span>
              </a>
              <a href="https://facebook.com" className="facebook" aria-label="Facebook">
                <span className="visually-hidden">Facebook</span>
              </a>
              <a href="https://instagram.com" className="instagram" aria-label="Instagram">
